...
extern void      rt_sys_init_s   (void (*task)(void), U8 priority, void *stk);
...
#define os_sys_init_s(tsk)              os_set_env();                           \
                                      _os_sys_init_s((U32)rt_sys_init_s,tsk,0,NULL)
...
extern void      _os_sys_init_s (U32 p, void (*task)(void), U32 prio_stksz,
                                     void *stk)                        __SVC_0;
